...
from heArtLVAD.src.sim_protocols.run_BiV_ClosedLoop_Ees2 import run_BiV_ClosedLoop as run_BiV_ClosedLoop
...
GuccioneParams = {"ParamsSpecified" : True, 
     		  ...
     		  "Passive params": {"Cparam": Constant(100.0*25*0.8), 
...
Circparam = {     "Ees_la": 350,
		  ...
		  "Cad": 0.0330,
    		  "Csv" : 0.3,
    		  "Vsa0" : 700*0.8, 
    		  "Vsv0" : 2500.0*0.8*1.2, #2500.0,-preload
		  "Vad0" : 40,
    		  "Rav" : 500.0,
    		  "Rsv" : 100.0,
    		  "Rsa" : 18000,
